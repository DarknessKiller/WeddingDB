<script lang="ts">
  ...
  import { Star, Users, Plus, MoreVertical, Pencil, Trash2, X } from 'lucide-svelte';
...
<div class="p-4 sm:p-7 max-w-[1400px]" onclick={() => contextMenu = null}>
  ...
  {#if loading}
    <div class="grid {gridCols} gap-4">
      {#each Array(8) as _, i}
        <div class="bg-white border border-gray-200 rounded-2xl p-5 flex flex-col items-center gap-3 animate-pulse">
