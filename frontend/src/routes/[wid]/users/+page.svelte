  ...
  <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div class="relative bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
      ...
      <div class="p-5 space-y-4">
        <div>
          <label for="user-name" class="text-sm font-semibold text-gray-700 mb-1.5 block">Name</label>
          <input id="user-name" bind:value={formName} class="w-full px-4 py-2.5 border border-black/[0.08] rounded-xl text-sm bg-white/80 focus:border-red focus:ring-2 focus:ring-red/10 outline-none transition-all min-h-[44px]" placeholder="Full name" />
        </div>
        <div>
          <label for="user-email" class="text-sm font-semibold text-gray-700 mb-1.5 block">Email</label>
          <input id="user-email" type="email" bind:value={formEmail} class="w-full px-4 py-2.5 border border-black/[0.08] rounded-xl text-sm bg-white/80 focus:border-red focus:ring-2 focus:ring-red/10 outline-none transition-all min-h-[44px]" placeholder="email@example.com" />
        </div>
        <div>
          <label for="user-password" class="text-sm font-semibold text-gray-700 mb-1.5 block">Password</label>
          <input id="user-password" type="password" bind:value={formPassword} minlength="8" class="w-full px-4 py-2.5 border border-black/[0.08] rounded-xl text-sm bg-white/80 focus:border-red focus:ring-2 focus:ring-red/10 outline-none transition-all min-h-[44px]" placeholder="Min 8 characters" />
          <PasswordRequirements password={formPassword} />
        </div>
        <div>
          <label for="user-confirm-password" class="text-sm font-semibold text-gray-700 mb-1.5 block">Confirm Password</label>
          <input id="user-confirm-password" type="password" bind:value={formConfirmPassword} minlength="8"
        ...
        <div>
          <label for="user-role" class="text-sm font-semibold text-gray-700 mb-1.5 block">Role</label>
          <select id="user-role" bind:value={formRole} class="w-full px-4 py-2.5 border border-black/[0.08] rounded-xl text-sm bg-white/80 focus:border-red focus:ring-2 focus:ring-red/10 outline-none transition-all min-h-[44px]">
            <option value="user">User</option>
            <option value="admin">Admin</option>
          </select>
        </div>
